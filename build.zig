...
pub fn build(b: *std.Build) !void {
	...
	var opt: Options = .{
		.ay = b.option(bool, "ay",
			"Enable support for Spectrum ZX music emulation") orelse default.ay,
		.gbs = b.option(bool, "gbs",
			"Enable support for Game Boy music emulation") orelse default.gbs,
		.gym = b.option(bool, "gym",
			"Enable Sega MegaDrive/Genesis music emulation") orelse default.gym,
		.hes = b.option(bool, "hes",
			"Enable PC Engine/TurboGrafx-16 music emulation") orelse default.hes,
		.kss = b.option(bool, "kss",
			"Enable MSX or other Z80 systems music emulation") orelse default.kss,
		.nsf = b.option(bool, "nsf",
			"Enable NES NSF music emulation") orelse default.nsf,
		.nsfe = b.option(bool, "nsfe",
			"Enable NES NSFE and NSF music emulation") orelse default.nsfe,
		.sap = b.option(bool, "sap",
			"Enable Atari SAP music emulation") orelse default.sap,
		.spc = b.option(bool, "spc",
			"Enable SNES SPC music emulation") orelse default.spc,
		.vgm = b.option(bool, "vgm",
			"Enable Sega VGM/VGZ music emulation") orelse default.vgm,
		.linkage = b.option(LinkMode, "linkage",
			"Library linking method") orelse default.linkage,
		.ym2612_emu = b.option(Ym2612Emu, "ym2612_emu",
			"Which YM2612 emulator to use.") orelse default.ym2612_emu,
